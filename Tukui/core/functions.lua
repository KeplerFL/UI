...
T.PP = function(p, obj)
	...
	elseif p == 6 then
		...
		obj:SetPoint('BOTTOM', right)
	elseif p == 7 then
		obj:SetParent(bottom)
		obj:SetHeight(bottom:GetHeight())
		obj:SetPoint("LEFT", bottom, 30, 0)
	...
	elseif p == 9 then
		obj:SetParent(bottom)
		obj:SetHeight(bottom:GetHeight())
		obj:SetPoint("RIGHT", bottom, -30, 0)
		obj:SetPoint('TOP', bottom)
		obj:SetPoint('BOTTOM', bottom)
	elseif p == 10 then
