...
if C["unitframes"].layout ~= 3 then return end
------------------------------------------------------------------------
--	local variables
------------------------------------------------------------------------
...
local function Shared(self, unit)
	...
	if (unit == "player" or unit == "target") then
		...
		if T.lowversion then
			panel:CreatePanel("Default", 176, 21, "BOTTOM", self, "BOTTOM", 0, 0)
		else
		...
		if (C["unitframes"].charportrait == true) then
			...
			-- if T.lowversion then
				portrait:SetHeight(self.Health:GetHeight() + self.Power:GetHeight()+20)
		--	else
			...
			portrait:SetAlpha(1)
			if unit == "player" then
				portrait:SetPoint("BOTTOMLEFT", power, "BOTTOMLEFT", -portrait:GetWidth()-7,0)
			elseif unit == "target" then
				portrait:SetPoint("BOTTOMRIGHT", power, "BOTTOMRIGHT", portrait:GetWidth()+7,0)
			end
		...
		Name:Point("BOTTOMLEFT", self.Health, "TOPLEFT", 2, 5)
