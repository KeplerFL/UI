...
local TukuiShift = CreateFrame("Frame","TukuiShiftBar",TukuiTabsLeftBackground)
TukuiShift:SetPoint("BOTTOMLEFT", TukuiTabsLeftBackground, "TOPLEFT", -0, -21)
...
T.set_anim(TukuiShift, true, -500, 0 ,.6)
